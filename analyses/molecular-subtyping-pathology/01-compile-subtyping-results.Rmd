...
hgg_results_df <- bind_exp_strategies(hgg_results_df) %>%
  ...
  mutate(integrated_diagnosis = case_when(grepl("DMG, H3 K28", molecular_subtype) ~ "Diffuse midline glioma, H3 K28-altered",
                                          ...
                                          ## Add PXA
                                          grepl("PXA", molecular_subtype) ~ "High-grade glioma, pleomorphic xanthoastrocytoma",
                                          TRUE~ NA_character_),
