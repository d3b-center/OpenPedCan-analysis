...
print(paste("RNA-Seq biospecimen in histologies missing in gene-counts-rsem-expected_count-collapsed.rds = ", length(missing_ids)))
...
print(paste("RNA-Seq biospecimen in gene-counts-rsem-expected_count-collapsed.rds missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("RNA-Seq biospecimen in histologies missing in gene-expression-rsem-tpm-collapsed.rds = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("RNA-Seq biospecimen in gene-expression-rsem-tpm-collapsed.rds missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("RNA-Seq biospecimen in histologies missing in rna-isoform-expression-rsem-tpm.rds = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("RNA-Seq biospecimen in rna-isoform-expression-rsem-tpm.rds missing in histologies = ", length(missing_hist_ids)))
```
...
<!--   missing_ids_df -->
<!-- } -->
<!-- print(paste("RNA-Seq biospecimen in histologies missing in tcga-gene-counts-rsem-expected_count-collapsed.rds = ", length(missing_ids))) -->
<!-- if (length(missing_hist_ids) > 0) { -->
...
<!--   missing_hist_ids_df -->
<!-- } -->
<!-- print(paste("RNA-Seq biospecimen in tcga-gene-counts-rsem-expected_count-collapsed.rds missing in histologies = ", length(missing_hist_ids))) -->
<!-- ``` -->
...
print(paste("RNA-Seq biospecimen in histologies missing in tcga-gene-expression-rsem-tpm-collapsed.rds = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("RNA-Seq biospecimen in tcga-gene-expression-rsem-tpm-collapsed.rds missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("Methylation biospecimen in histologies missing in methyl-beta-values.rds = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("Methylation biospecimen in methyl-beta-values.rds missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("Methylation biospecimen in histologies missing in methyl-m-values.rds = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("Methylation biospecimen in methyl-m-values.rds missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("Methylation biospecimen in histologies missing in methyl-cn-values.rds = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("Methylation biospecimen in methyl-cn-values.rds missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("DNA biospecimen in histologies missing in cnv-cnvkit.seg.gz = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("DNA biospecimen in cnv-cnvkit.seg.gz missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("DNA biospecimen in histologies missing in cnv-controlfreec.tsv.gz = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("DNA biospecimen in cnv-controlfreec.tsv.gz missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("DNA biospecimen in histologies missing in cnv-gatk.seg.gz = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("DNA biospecimen in cnv-gatk.seg.gz missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("DNA biospecimen in histologies missing in snv-consensus-plus-hotspots.maf.tsv.gz = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("DNA biospecimen in snv-consensus-plus-hotspots.maf.tsv.gz missing in histologies = ", length(missing_hist_ids)))
```
...
#  missing_ids_df
#}
#print(paste("DNA biospecimen in histologies missing in snv-dgd.maf.tsv.gz = ", length(missing_ids)))
#if (length(missing_hist_ids) > 0) {
...
#  missing_hist_ids_df
#}
#print(paste("DNA biospecimen in snv-dgd.maf.tsv.gz missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("DNA biospecimen in histologies missing in sv-manta.tsv.gz = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("DNA biospecimen in sv-manta.tsv.gz missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("DNA biospecimen in histologies missing in biospecimen_id_to_bed_map.tsv = ", length(missing_ids)))
if (length(missing_hist_ids) > 0) {
...
print(paste("DNA biospecimen in biospecimen_id_to_bed_map.tsv missing in histologies = ", length(missing_hist_ids)))
```
...
<!--   missing_ids_df -->
<!-- } -->
<!-- print(paste("RNA biospecimen in histologies missing in splice-events-rmats.tsv.gz = ", length(missing_ids))) -->
<!-- if (length(missing_hist_ids) > 0) { -->
...
<!--   missing_hist_ids_df -->
<!-- } -->
<!-- print(paste("RNA biospecimen in splice-events-rmats.tsv.gz missing in histologies = ", length(missing_hist_ids))) -->
<!-- ``` -->
...
## access all RNA-seq except the ones from DGD, TCGA and GTEx
hist_ids <- hist_df %>%
  dplyr::filter(experimental_strategy == "RNA-Seq",
...
print(paste("RNA biospecimen in fusion-annoFuse.tsv.gz missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("RNA biospecimen in fusion-arriba.tsv.gz missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("RNA biospecimen in fusion-starfusion.tsv.gz missing in histologies = ", length(missing_hist_ids)))
```
...
print(paste("RNA biospecimen in fusion-dgd.tsv.gz missing in histologies = ", length(missing_hist_ids)))
```
