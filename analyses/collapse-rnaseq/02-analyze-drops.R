params <-
list(polya.annot.table = "results/pbta-gene-expression-rsem-fpkm-collapsed_table.polya.rds", 
    stranded.annot.table = "results/pbta-gene-expression-rsem-fpkm-collapsed_table.stranded.rds")
