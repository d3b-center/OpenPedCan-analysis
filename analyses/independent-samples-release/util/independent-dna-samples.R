...
#'   randomly select among all available specimens. As of v11, primary tumors
#'   are defined as those designated "Initial CNS Tumor", "Diagnosis", or "Primary Tumor" in the
