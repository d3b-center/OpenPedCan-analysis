params <-
list(histology = "data/pbta-histologies.tsv", dataPutativeFusion = "scratch/pbta-fusion-putative-oncogenic-preQC.tsv",
    countHistology = 4L, outputfolder = "results",
    base_histology = "data/pbta-histologies-base.tsv")
...
#'
## ----get subset of fusion calls to review-------------------------------------
...
#'
#'
## ----function to plot FusionName to N number of histologies-------------------
