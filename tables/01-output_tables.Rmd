...
EFO_MONDO <- read_tsv(file.path(root_dir, "analyses", "efo-mondo-mapping", "results", "efo-mondo-map.tsv"))
```
...
"efo_code", "The Experimental Factor Ontology (EFO) provides systematic description of experimental variables including cancer groups available in European Bioinformatics Institute databases and some other external projects", "text",
...
"mondo_code", "The Mondo Disease Ontology (MONDO) is an independent resource aiming to harmonize disease definitions", "text",
"ncit_code", "NCI Thesaurus (NCIt) provides reference terminology for many NCI and other systems", "text",
...
# Combine histology with EFO/MONDO
histology_df <- histology_df %>% 
  left_join(EFO_MONDO, by = c("cancer_group" = "cancer_group"))
# Combine and output
