...
```{r}
metadata <-
  readr::read_tsv(file.path(input_dir, "histologies.tsv"), guess_max = 10000)
```
...
```
(
Make this notebook stop if there are more than 128 histology groups (including "Unknown"). 
